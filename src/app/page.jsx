    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <section className="container flex flex-col items-center justify-center gap-4 py-24 md:py-32">
        <div className="flex max-w-5xl flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-[42rem] animate-fade-up text-muted-foreground md:text-xl">
          ...
          <div className="mt-8 flex animate-fade-up flex-wrap items-center justify-center gap-4">
        ...
        {/* Hero SVG/Image */}
        <div className="mt-16 flex w-full max-w-4xl animate-fade-up items-center justify-center">
          <HeroSvg />
        </div>
      </section>
